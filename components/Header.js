...
function Header({placeholder}) {
  ...
  const [startDate, setStartDadte] = useState(new Date());
  ...
  const handleSelect = (ranges)=> {
    setStartDadte(ranges.selection.startDate);
    ...
    return (
        ...
        {searchInput  && (
          <div className="flex flex-col col-span-3 mx-auto">
              ...
              <div className="flex">
                <button onClick={resetInput} className="flex-grow text-gray-400">Cansel</button>
